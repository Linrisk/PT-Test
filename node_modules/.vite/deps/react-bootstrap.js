import {
  Row_default
} from "./chunk-JQP3W5OH.js";
import {
  Col_default,
  useCol
} from "./chunk-IMVTKHGG.js";
import {
  Container_default
} from "./chunk-TKXBML2I.js";
import {
  ModalBody_default,
  ModalDialog_default,
  ModalFooter_default,
  ...
  ModalTitle_default,
  Modal_default
} from "./chunk-GUFNOGBD.js";
import {
  CardHeaderContext_default,
  NavItem_default,
  Nav_default,
  Nav_default2
} from "./chunk-HJW7RG73.js";
import {
  Collapse_default,
  NavbarBrand_default,
  Navbar_default,
...
import {
  ...
  useWaitForDOMRef,
  useWillUnmount
} from "./chunk-PYVE554G.js";
import {
  ENTERING,
  EXITING,
  hasClass
} from "./chunk-WUOM2T6L.js";
import {
  ...
  usePopper_default
} from "./chunk-TZYV443Z.js";
import {
  Button_default
} from "./chunk-X47JKYAX.js";
import {
  Anchor_default,
  NavLink_default,
  TabContext_default,
  useNavItem
} from "./chunk-BXNKXBDO.js";
import "./chunk-YXTSBPAS.js";
import {
  useCallbackRef
} from "./chunk-GJAFOMXF.js";
import {
  contains,
  listen_default,
  ownerDocument
} from "./chunk-7ZK7CTN4.js";
import {
  require_prop_types
...
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-4LIQUCKY.js";
import "./chunk-7CYDX2RJ.js";
import {
  createWithBsPrefix,
  ...
  useMounted
} from "./chunk-4FQVZ5YO.js";
import "./chunk-RD6NPZFS.js";
import {
  require_classnames
...
var Carousel = React20.forwardRef((uncontrolledProps, ref) => {
  const {
    as: Component2 = "div",
    bsPrefix,
    slide,
...
var DropdownButton = React21.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime22.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime21.jsx)(DropdownToggle_default, {
    id,
    href,
    size,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime21.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var Feedback = React22.forwardRef(
  ({
    ...
    ...props,
    ref,
    className: (0, import_classnames18.default)(className, `${type}-${tooltip ? "tooltip" : "feedback"}`)
  })
);
...
var FormCheckInput = React24.forwardRef(({
  ...
  return (0, import_jsx_runtime24.jsx)(Component2, {
    ...
    type,
    id: id || controlId,
    className: (0, import_classnames19.default)(className, bsPrefix, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormCheck = React26.forwardRef(({
  ...
  return (0, import_jsx_runtime26.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime26.jsx)("div", {
      style,
      className: (0, import_classnames21.default)(className, hasLabel && bsPrefix, inline && `${bsPrefix}-inline`, reverse && `${bsPrefix}-reverse`, type === "switch" && bsSwitchPrefix),
...
var FormControl = React27.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames22.default)(className, classes, isValid && `is-valid`, isInvalid && `is-invalid`, type === "color" && `${bsPrefix}-color`)
  });
});
...
var FormGroup = React28.forwardRef(({
  controlId,
  as: Component2 = "div",
  ...props
}, ref) => {
...
var FormLabel = React29.forwardRef(({
  as: Component2 = "label",
  bsPrefix,
  column,
  visuallyHidden,
...
var FormRange = React30.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React31.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime33.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames25.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React32.forwardRef(
  ({
    bsPrefix,
    className,
    as: Component2 = "small",
...
var Switch = React33.forwardRef((props, ref) => (0, import_jsx_runtime35.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React34.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroupCheckbox = (props) => (0, import_jsx_runtime41.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime41.jsx)(FormCheckInput_default, {
    type: "checkbox",
    ...props
  })
});
var InputGroupRadio = (props) => (0, import_jsx_runtime41.jsx)(InputGroupText, {
  children: (0, import_jsx_runtime41.jsx)(FormCheckInput_default, {
    type: "radio",
    ...props
  })
...
var InputGroup = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime41.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime41.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames31.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var Overlay = React41.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime44.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
var Popover = React43.forwardRef(({
  ...
  return (0, import_jsx_runtime46.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime45.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime45.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
Popover.defaultProps = defaultProps12;
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react21.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React44.forwardRef(({
  children: overlay,
  transition,
  popperConfig = {},
  ...outerProps
  ...
  return (0, import_jsx_runtime47.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React44.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
Overlay2.defaultProps = defaultProps13;
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React45.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime50.jsxs)(import_jsx_runtime49.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react23.cloneElement)(children, triggerProps), (0, import_jsx_runtime48.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
OverlayTrigger.defaultProps = defaultProps14;
...
var PageItem = React46.forwardRef(({
  ...
  return (0, import_jsx_runtime51.jsx)("li", {
    ...
    children: (0, import_jsx_runtime52.jsxs)(Component2, {
      className: "page-link",
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime51.jsx)("span", {
        className: "visually-hidden",
...
PageItem.defaultProps = defaultProps15;
...
function createButton(name, defaultValue, label = name) {
  const Button = React46.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime52.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React47.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames37.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames38.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React48.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime54.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime56.jsx)("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime56.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React50.forwardRef(({
  isChild,
  ...props
}, ref) => {
...
ProgressBar.defaultProps = defaultProps16;
...
var Ratio = React51.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)("div", {
    ...
    children: React51.Children.only(children)
  });
});
Ratio.defaultProps = defaultProps17;
...
var Spinner = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames41.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React53.forwardRef(({
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime60.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime59.jsx)(Button_default, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime59.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size,
    variant,
  ...
  }), (0, import_jsx_runtime59.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
SplitButton.defaultProps = defaultProps18;
...
var Stack = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime61.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames42.default)(className, bsPrefix, ...createUtilityClassName({
      gap,
      breakpoints,
      minBreakpoint
    }))
    ...
    return (0, import_jsx_runtime62.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime62.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime62.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime62.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime64.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React58.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime65.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime65.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime67.jsx)(import_jsx_runtime66.Fragment, {});
};
...
var Table = React60.forwardRef(({
  ...
  const table = (0, import_jsx_runtime68.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime69.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime69.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime70.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime69.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      children: map(children, renderTab)
    }), (0, import_jsx_runtime69.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime69.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
Tabs2.defaultProps = defaultProps19;
...
var ToastFade = React62.forwardRef((props, ref) => (0, import_jsx_runtime71.jsx)(Fade_default, {
  ...props,
  ref,
...
var Toast = React65.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime74.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames46.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime74.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime74.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React66.forwardRef(({
  ...
  return (0, import_jsx_runtime75.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(bsPrefix, position && [containerPosition ? `position-${containerPosition}` : null, positionClasses[position]], className)
  });
});
...
var ToggleButton = React67.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime77.Fragment, {
    children: [(0, import_jsx_runtime76.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime76.jsx)(Button_default, {
      ...props,
      ref,
      className: (0, import_classnames48.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React68.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime79.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    children: map(children, (child) => {
      const values = getValues();
...
var Tooltip = React69.forwardRef(({
  bsPrefix,
  placement,
  className,
  style,
