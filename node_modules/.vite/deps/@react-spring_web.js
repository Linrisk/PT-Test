...
function Me2(t, { key: e2, props: n2, defaultProps: r2, state: o, actions: s }) {
  return new Promise((a, i2) => {
    var _a2;
    let u4, p3, f3 = te2((_a2 = n2.cancel) != null ? _a2 : r2 == null ? void 0 : r2.cancel, e2);
    if (f3)
      b4();
    else {
...
var ue2 = class extends X3 {
  ...
  _stop(e2, n2) {
    if (Q4(this)) {
      ...
      let o = n2 ? q2(this.get()) : E2(this.get(), Ce2(this, e2 != null ? e2 : r2.to));
...
function Cs(t, e2) {
  ...
  return Q2(() => {
    let b4 = o.current, { root: c5, once: P2, amount: l4 = "any", ...h5 } = f3 != null ? f3 : {};
